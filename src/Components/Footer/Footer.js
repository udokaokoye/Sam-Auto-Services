...
import { faCode, faCopyright, faEnvelope, faMapMarkerAlt, faPaperPlane, faPhone } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div className='footer_container'>
            ...
            <div className="copyrights_developer">
                <p><FontAwesomeIcon icon={faCopyright} /> Copyrights Sam's Auto 2021. All rights reserved.</p>
